...
export function FindUs({ classes }: { classes: ClassGroup[] }) {
  return (
    <section id="find-us" className="scroll-mt-20">
      <div className="mx-auto max-w-[1400px] px-4 pt-8 pb-12 sm:px-6 lg:px-10 lg:pt-8 lg:pb-16">
        <h2 className="text-xl font-semibold tracking-tight sm:text-2xl">
          Find <em className="font-serif font-normal italic">us</em>
        </h2>
        <ul className="mt-6 grid gap-4 text-sm text-cream-dim sm:grid-cols-2">
